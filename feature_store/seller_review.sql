...
select * FROM silver_olist.orders
...
tb_summary as(
  SELECT idSeller, 
         ...
         sum(case when datediff('2018-01-01',dtPurchase)< 30 then qtReviews end) as qtReviews1M,
         sum(case when datediff('2018-01-01',dtPurchase)< 30 then qtMensagem end) as qtMensagem1M,
         ...
         sum(case when datediff('2018-01-01',dtPurchase)< 90 then qtReviews end) as qtReviews3M,
         sum(case when datediff('2018-01-01',dtPurchase)< 90 then qtMensagem end) as qtMensagem3M,
